...
namespace PHPSTORM_META {
    ...
    * Generated on 2019-01-14 00:07:10.
    *
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        ...
        'command.wn.controller' => \Wn\Generators\Commands\ControllerCommand::class,
        'command.wn.controller.rest-actions' => \Wn\Generators\Commands\ControllerRestActionsCommand::class,
        'command.wn.factory' => \Wn\Generators\Commands\FactoryCommand::class,
        'command.wn.migration' => \Wn\Generators\Commands\MigrationCommand::class,
        'command.wn.model' => \Wn\Generators\Commands\ModelCommand::class,
        'command.wn.pivot-table' => \Wn\Generators\Commands\PivotTableCommand::class,
        'command.wn.resource' => \Wn\Generators\Commands\ResourceCommand::class,
        'command.wn.resources' => \Wn\Generators\Commands\ResourcesCommand::class,
        'command.wn.route' => \Wn\Generators\Commands\RouteCommand::class,
